...
const UserItem = (props: UserItemProps) => {
  ...
  return (
    <Accordion expanded={expanded} onChange={(_, expanded) => setExpanded(expanded)}>
      <AccordionSummary aria-controls={`panel-${person.id}-content"`} id={`panel-${person.id}-header"`}>
      ...
      <AccordionDetails>
        {expanded && (
          <Stack spacing='16px'>
            ...
            >
              <MFAStatus role={person.profile.global_role} mfa_enabled={person.profile.mfa_enabled} />

              <Activity createdAt={person.profile.createdAt} last_seen={last_seen} />
            </Box>
            ...
            <BasicInfo person={person} firstnameRef={firstnameRef} lastnameRef={lastnameRef} emailRef={emailRef} />
            ...
            <Grid container spacing={{ xs: 1, md: 2 }}>
              ...
              {person.profile.mfa_enabled && (
                <>
                  ...
                  <ButtonGrid color='warning' onClick={onDisableMFA} startIcon={<NoEncryptionGmailerrorred />}>
                    Disable MFA
                  </ButtonGrid>
                </>
              )}
